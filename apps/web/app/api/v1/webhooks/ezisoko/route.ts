...
export async function POST(req: Request) {
  const WEBHOOK_SECRET = getEnv(req, "EZISOKO_CLERK_WEBHOOK_SECRET");

  if (!WEBHOOK_SECRET) {
    console.error("Missing EZISOKO WEBHOOK_SECRET environment variable");
    throw new Error("Missing EZISOKO WEBHOOK_SECRET environment variable");
  }
